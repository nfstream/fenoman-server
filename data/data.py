...
class Data:
    def __init__(self, df: str = TEST_DATAFRAME) -> None:
        ...
        """X_scaled has no such columns but regex doesn't affect it"""
        ...
        """X_scaled has already encoded protocol columns"""
        ...
        """Unnecessary encodings if we work with X_scaled"""
        ...
        """In X_scaled the number of features are 13"""
        n_features = 13
        ...
        """ Don't need to scale or transform to pandas df, because we don't need to manipulate protocol column
         in X_scaled dataset """
        # scale
        ...
        """X_scaled's protocol column is divided to two and encoded, by default"""
        ...
        self.__data = comnet_normalized.join(target)
